...
actor UpdateChecker {
    ...
    func check() async -> Result {
        guard let apiURL = URL(string: "https://api.github.com/repos/sevmorris/WireHack/releases/latest") else {
        ...
        do {
            ...
            let releaseURL = URL(string: release.htmlUrl)
                ?? URL(string: "https://github.com/sevmorris/WireHack/releases")!
...
func checkForUpdates(silent: Bool = false) async {
    ...
    case .upToDate(let version):
        ...
        alert.informativeText = "WireHack \(version) is the latest version."
    ...
    case .available(let version, let downloadURL, let releaseURL):
        ...
        alert.informativeText = "WireHack \(version) is available."
